...
include('Backend/Database_Quiz.php');?></div>
...
if ($result) {
    ...
    while ($row = $result->fetch_row()) {
        ...
        // Create links that lead to a page displaying table contents
        echo '<div class="slider-box">';
        echo '<a href="Quiz.php?name=' . urlencode($tableName) . '">' . $tableName . '</a>';
        echo '</div>';
    }
