...
<head>
  ...
  <title>PDF Links with Search</title>
...
<!-- <div class="navbar_content">
  ...
  <h2>PDF Gallery</h2></div>
  


    <div id="search-container">
      <input type="text" class="search-input" id="search-input" placeholder="Search for pdf...">
    ...
    foreach ($images as $filename) {
      if ($filename !== '.' && $filename !== '..') {
        ...
        echo '<a href="PDF_display.php?image=' . urlencode($filename) . '">' . $filename . '</a></div>';
      }
    }
    ?>
    <div id="nosearch" style=" padding: 10px; display: none;">
